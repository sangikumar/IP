...
class auth{
	...
	var $HOST = "development.cwjgdp1wxdy2.us-west-1.rds.amazonaws.com";	// Change this to the proper DB HOST
	var $USERNAME = "whiteboxqa";	// Change this to the proper DB USERNAME
	var $PASSWORD = "Innovapath1*";	// Change this to the proper DB USER PASSWORD
	var $DBNAME = "whiteboxqa";	// Change this to the proper DB NAME
