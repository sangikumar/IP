...
{	
	...
	else
	{
		...
		//inactive
		if(isset($_POST['inactivate']) && $_POST['inactivate'] == "inactivate"){
			if (setUserInActive($userdetails['activation_token'])){
				$successes[] = lang("ACCOUNT_MANUALLY_INACTIVATED", array($displayname));
			}
			else {
				$errors[] = lang("SQL_ERROR");
			}
...
$permissionData = fetchAllHRPermissions();
...
if ($userdetails['active'] == '1'){
	...
	<input type='checkbox' name='inactivate' id='inactivate' value='inactivate'>	
	";	
}
else{
	echo "No
