...
<tr>
<td><label>Email Activation:</label></td>
<td><select name='settings[".$settings['activation']['id']."]'>";
...
<td><select name='settings[".$settings['template']['id']."]'>";
