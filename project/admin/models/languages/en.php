...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_ACTIVATION_MESSAGE"		=> "You will need to activate your account before you can login. Please follow the link below to activate your account. <br />
	...
	"ACCOUNT_MANUALLY_INACTIVATED"		=> "%m1%'s account has been manually inactivated",
	"ACCOUNT_DISPLAYNAME_UPDATED"		=> "Displayname changed to %m1%",
	"ACCOUNT_TITLE_UPDATED"			=> "%m1%'s title changed to %m2%",
	"ACCOUNT_PASS_UPDATED"			=> "%m1%'s password changed to %m2%",
