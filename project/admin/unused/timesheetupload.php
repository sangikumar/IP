...
if($_GET['userid'] != $userId){
  //header("Location: timesheetupload.php"); die();
}
...
<div id='main'>
	...
	<span style='color:red'>Please upload your timesheet screenshots here. You still have to enter the timesheet info into the timesheet grid.</span><br /><br />
  <form action="timesheetupload.php" method="post"  enctype="multipart/form-data">
    <label for="file"><span class="txt1">Please upload your timesheets: </span></label>
