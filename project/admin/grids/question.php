...
// Write the SQL Query
$grid->SelectCommand = 'SELECT id,  category, type, subject,question, answer, keywords FROM questions';
...
$grid->setUrl('../grids/question.php');
...
$grid->setSelect("category", $questionscategory, false, true, true, array(""=>"All"));
$grid->setColProperty("type", array("editable"=>true, "width"=>100, "fixed"=>true, "label"=>"Type", "edittype"=>"select"));
$grid->setSelect("type", $questionstype, false, true, true, array(""=>"All"));
