...
// Write the SQL Query
$grid->SelectCommand = 'SELECT id, description, startdate, duedate, priority, employee, manager, shadow, shadow2, shadow3, status, pctcomplete, closedate, notes FROM task where "all" = "'. $status .'" or status = "'. $status .'"';
...
$grid->setUrl('../grids/task.php?status='.$status);
...
$grid->setGridOptions(array(
    ...
    "rowNum"=>100,
		"shrinkToFit"=>false,
    "sortname"=>"status asc, duedate asc, startdate asc, manager asc, pctcomplete",
		"sortorder"=>"asc",
		"toppager"=>true,
