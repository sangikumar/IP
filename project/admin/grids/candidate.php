...
$grid->setColProperty("guarantorname", array("editable"=>true, "width"=>150, "fixed"=>true, "label"=>"Gurantor Name"));
$grid->setColProperty("guarantordesignation", array("editable"=>true, "width"=>150, "fixed"=>true, "label"=>"Gurantor Desig"));
$grid->setColProperty("guarantorcompany", array("editable"=>true, "width"=>150, "fixed"=>true, "label"=>"Gurantor Company"));
...
$summaryrows = array("feedue"=>array("feedue"=>"SUM"), "feepaid"=>array("feepaid"=>"SUM"));					
...
$grid->setColProperty("originalresume", array("editable"=>true, "frozen"=>true, "width"=>200, "editoptions"=>array("size"=>75, "maxlength"=>200), "formatter"=>"link", "formatoptions"=>array("target"=>"_blank"), "fixed"=>true, "editrules"=>array("url"=>true, "required"=>false), "label"=>"Resume Url"));
...
$grid->setColProperty("ssnurl", array("editable"=>true, "frozen"=>true, "width"=>200, "editoptions"=>array("size"=>75, "maxlength"=>200), "formatter"=>"link", "formatoptions"=>array("target"=>"_blank"), "fixed"=>true, "editrules"=>array("url"=>true, "required"=>false), "label"=>"SSN Url"));
...
$grid->setSelect("batchname", "select distinct batchname as id, batchname as name from batch order by name desc", false, true, true);
