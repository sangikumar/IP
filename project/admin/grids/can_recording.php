...
$grid->SelectCommand = 'SELECT id,employeeid,description,sessiondate,link,videoid,status,category FROM can_recording';
$grid->table = 'can_recording';
...
$grid->setColModel();
$grid->setUrl('../grids/can_recording.php');
...
$grid->setGridOptions(array(
	  ...
	  "width"=>1024,
		"height"=>400,
		"caption"=>"Candidate Recording Management",		
		"rownumbers"=>true,										
    "rowNum"=>100,
