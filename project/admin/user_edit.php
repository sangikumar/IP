...
$userdetails = fetchCandidateDetails(NULL, NULL, $userId); //Fetch user details
...
{	
	...
	else
	{
		...
		$userdetails = fetchCandidateDetails(NULL, NULL, $userId);
	}
}

$userPermission = fetchUserPermissions($userId);
$permissionData = fetchCandidatePermissions();
