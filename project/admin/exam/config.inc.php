...
//database server
define('DB_SERVER', "development.cwjgdp1wxdy2.us-west-1.rds.amazonaws.com");

//database login name
define('DB_USER', "whiteboxqa");
//database login password
define('DB_PASS', "Innovapath1*");

//database name
define('DB_DATABASE', "whiteboxqa");
...
define('DETAIL_SEP',"^|^");
define('SITENAME',"Innovapath");
define('SITETITLE',"Avatar");
define('SITE_LINK',"http://innova-path.com");
