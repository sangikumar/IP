...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#loader').hide();
            $('#show_heading').hide();
            $("#faq_search_input").watermark("Search clients...");

            //return page after save
            var inp = $("#faq_search_input");
            if (inp.val() != "Search clients..." && inp.val().length > 2) {
                $.post("../ajax-content/get-client.php", {
            ...
            $('#faq_search_input').autocomplete({
                source: '../ajax-content/suggest_client.php', minLength: 2,
