...
<div id='main'>
    <?php 
      ...
      $result = mysql_query("select s.clientname, s.type, s.interviewdate, s.status, u.name manager from interview s, employee u where s.mmid = u.id and s.candidateid = (select candidateid from candidate where portalid = $userid) order by s.interviewdate desc");
      ...
      echo("</table></td></tr></table>");
			...
			{
			 echo "<span style='color:red'>No Interviews taken.</span><br /><br />";
			}			
