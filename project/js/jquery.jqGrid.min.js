...
this.id+"'>"+this.p.loadtext+"</div>").insertBefore(j);a(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"grid","aria-multiselectable":!!this.p.multiselect,"aria-labelledby":"gbox_"+this.id});var n=function(a,b){a=parseInt(a,10);return isNaN(a)?b||0:a},o=function(d,c,f,g,i,j){var l=b.p.colModel[d],m=l.align,k='style="',n=l.classes,o=l.name,q=[];m&&(k=k+("text-align:"+m+";"));l.hidden===true&&(k=k+"display:none;");if(c===0)k=k+("width: "+e.headers[d].width+"px;");else if(l.cellattr&&a.isFunction(l.cellattr))if((d=
...
a(this).text()});d=a.jgrid.getXmlData(d,j.root,true);(d=a.jgrid.getXmlData(d,j.row,true))||(d=[]);var A=d.length,M=0,P=[],K=parseInt(b.p.rowNum,10),T=b.p.scroll?a.jgrid.randId():1;if(A>0&&b.p.page<=0)b.p.page=1;if(d&&A){g&&(K=K*(g+1));var g=a.isFunction(b.p.afterInsertRow),U=false,J;if(b.p.grouping){U=b.p.groupingView.groupCollapse===true;J=a.jgrid.getMethod("groupingPrepare")}for(;M<A;){F=d[M];z=l(F,T+M);z=b.p.idPrefix+z;k=e===0?0:e+1;G=(k+M)%2===1?I:"";var R=O.length;O.push("");u&&O.push(r(0,M,
b.p.page,b.p.rowNum));y&&O.push(t(z,u,M,false));C&&O.push(L.call(m,y+u,M+e));if(j.repeatitems){N||(N=w(y+C+u));var S=a.jgrid.getXmlData(F,j.cell,true);a.each(N,function(a){var d=S[this];if(!d)return false;x=d.textContent||d.text;B[b.p.colModel[a+y+C+u].name]=x;O.push(q(z,x,a+y+C+u,M+e,F,B))})}else for(k=0;k<E.length;k++){x=a.jgrid.getXmlData(F,E[k]);B[b.p.colModel[k+y+C+u].name]=x;O.push(q(z,x,k+y+C+u,M+e,F,B))}O[R]=H(z,U,G,B,F,false);O.push("</tr>");if(b.p.grouping){P=J.call(m,O,P,B,M);O=[]}if(h||
...
10),K=b.p.scroll?a.jgrid.randId():1,T=false,U;g&&(P=P*(g+1));b.p.datatype==="local"&&!b.p.deselectAfterSort&&(T=true);var J=a.isFunction(b.p.afterInsertRow),R=[],S=false,aa;if(b.p.grouping){S=b.p.groupingView.groupCollapse===true;aa=a.jgrid.getMethod("groupingPrepare")}for(;o<d;){g=E[o];A=a.jgrid.getAccessor(g,z);if(A===void 0){typeof z==="number"&&b.p.colModel[z+y+C+L]!=null&&(A=a.jgrid.getAccessor(g,b.p.colModel[z+y+C+L].name));if(A===void 0){A=K+o;if(x.length===0&&c.cell){m=a.jgrid.getAccessor(g,
c.cell)||g;A=m!=null&&m[z]!==void 0?m[z]:A}}}A=b.p.idPrefix+A;m=e===1?0:e;G=(m+o)%2===1?M:"";T&&(U=b.p.multiselect?a.inArray(A,b.p.selarrrow)!==-1:A===b.p.selrow);var Q=I.length;I.push("");L&&I.push(r(0,o,b.p.page,b.p.rowNum));y&&I.push(t(A,L,o,U));C&&I.push(u.call(l,y+L,o+e));B=h;if(c.repeatitems){c.cell&&(g=a.jgrid.getAccessor(g,c.cell)||g);a.isArray(g)&&(B=D)}for(p=0;p<B.length;p++){m=a.jgrid.getAccessor(g,B[p]);F[b.p.colModel[p+y+C+L].name]=m;I.push(q(A,m,p+y+C+L,o+e,g,F))}I[Q]=H(A,S,G,F,g,U);
...
g="",h,j,l,k,m=function(d){var c;a.isFunction(b.p.onPaging)&&(c=b.p.onPaging.call(b,d));if(c==="stop")return false;b.p.selrow=null;if(b.p.multiselect){b.p.selarrrow=[];R(false)}b.p.savedRow=[];return true},d=d.substr(1),c=c+("_"+d);h="pg_"+d;j=d+"_left";l=d+"_center";k=d+"_right";a("#"+a.jgrid.jqID(d)).append("<div id='"+h+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='"+
...
cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},b.p.localReader);b.p.scroll&&(b.p.pgbuttons=!1,b.p.pginput=!1,b.p.rowList=[]);b.p.data.length&&y();var C="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",L,E,N,T,M,B,G,I,aa=I="",P=[],ha=[];E=[];if(!0===b.p.shrinkToFit&&!0===b.p.forceFit)for(g=b.p.colModel.length-1;0<=g;g--)if(!b.p.colModel[g].hidden){b.p.colModel[g].resizable=!1;break}"horizontal"===b.p.viewsortcols[1]&&(I=" ui-i-asc",aa=" ui-i-desc");
...
!0),b.p.colModel[g].lso="",E===b.p.sortname&&(b.p.lastsort=g),b.p.multiSort&&(E=a.inArray(E,P),-1!==E&&(b.p.colModel[g].lso=ha[E])),C+=I+"</div></th>";I=null;a(this).append(C+"</tr></thead>");a("thead tr:first th",this).hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});if(this.p.multiselect){var U=[],ba;a("#cb_"+a.jgrid.jqID(b.p.id),this).bind("click",function(){b.p.selarrrow=[];var d=b.p.frozenColumns===true?b.p.id+"_frozen":"";if(this.checked){a(b.rows).each(function(c){if(c>
...
ba=true;U=[]}else{a(b.rows).each(function(c){if(c>0&&!a(this).hasClass("ui-subgrid")&&!a(this).hasClass("ui-state-disabled")){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id))[b.p.useProp?"prop":"attr"]("checked",false);a(this).removeClass("ui-state-highlight").attr("aria-selected","false");U.push(this.id);if(d){a("#jqg_"+a.jgrid.jqID(b.p.id)+"_"+a.jgrid.jqID(this.id),b.grid.fbDiv)[b.p.useProp?"prop":"attr"]("checked",false);a("#"+a.jgrid.jqID(this.id),b.grid.fbDiv).removeClass("ui-state-highlight")}}});
b.p.selrow=null;ba=false}a(b).triggerHandler("jqGridSelectAll",[ba?b.p.selarrrow:U,ba]);a.isFunction(b.p.onSelectAll)&&b.p.onSelectAll.call(b,ba?b.p.selarrrow:U,ba)})}!0===b.p.autowidth&&(C=a(m).innerWidth(),b.p.width=0<C?C:"nw");(function(){var d=0,c=a.jgrid.cell_width?0:n(b.p.cellLayout,0),f=0,g,i=n(b.p.scrollOffset,0),j,l=false,k,m=0,o;a.each(b.p.colModel,function(){if(this.hidden===void 0)this.hidden=false;if(b.p.grouping&&b.p.autowidth){var e=a.inArray(this.name,b.p.groupingView.groupField);
...
true;if(b.p.colModel[d].resizable){T=document.createElement("span");a(T).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i).css("cursor","col-resize");a(this).addClass(b.p.resizeclass)}else T="";a(this).css("width",N+"px").prepend(T);T=null;var c="";if(b.p.colModel[d].hidden){a(this).css("display","none");c="display:none;"}Z=Z+("<td role='gridcell' style='height:0px;width:"+N+"px;"+c+"'></td>");e.headers[d]={width:N,el:this};M=b.p.colModel[d].sortable;if(typeof M!=="boolean")M=b.p.colModel[d].sortable=
...
Q&&a(e.sDiv).hide());g=null;if(b.p.caption){var ia=b.p.datatype;!0===b.p.hidegrid&&(a(".ui-jqgrid-titlebar-close",e.cDiv).click(function(d){var c=a.isFunction(b.p.onHeaderClick),f=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-pager, .ui-jqgrid-sdiv",g,i=this;if(b.p.toolbar[0]===true){b.p.toolbar[1]==="both"&&(f=f+(", #"+a(e.ubDiv).attr("id")));f=f+(", #"+a(e.uDiv).attr("id"))}g=a(f,"#gview_"+a.jgrid.jqID(b.p.id)).length;b.p.gridstate==="visible"?a(f,"#gbox_"+a.jgrid.jqID(b.p.id)).slideUp("fast",function(){g--;
if(g===0){a("span",i).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s");b.p.gridstate="hidden";a("#gbox_"+a.jgrid.jqID(b.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(b.p.id)).hide();a(b).triggerHandler("jqGridHeaderClick",[b.p.gridstate,d]);c&&(Q||b.p.onHeaderClick.call(b,b.p.gridstate,d))}}):b.p.gridstate==="hidden"&&a(f,"#gbox_"+a.jgrid.jqID(b.p.id)).slideDown("fast",function(){g--;if(g===0){a("span",i).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n");
if(Q){b.p.datatype=ia;z();Q=false}b.p.gridstate="visible";a("#gbox_"+a.jgrid.jqID(b.p.id)).hasClass("ui-resizable")&&a(".ui-resizable-handle","#gbox_"+a.jgrid.jqID(b.p.id)).show();a(b).triggerHandler("jqGridHeaderClick",[b.p.gridstate,d]);c&&(Q||b.p.onHeaderClick.call(b,b.p.gridstate,d))}});return false}),Q&&(b.p.datatype="local",a(".ui-jqgrid-titlebar-close",e.cDiv).trigger("click")))}else a(e.cDiv).hide();a(e.hDiv).after(e.bDiv).mousemove(function(a){if(e.resizing){e.dragMove(a);return false}});
a(".ui-jqgrid-labels",e.hDiv).bind("selectstart",function(){return false});a(document).bind("mouseup.jqGrid"+b.p.id,function(){if(e.resizing){e.dragEnd();return false}return true});b.formatCol=o;b.sortData=X;b.updatepager=function(d,c){var e,f,g,i,h,j,l,m="",k=b.p.pager?"_"+a.jgrid.jqID(b.p.pager.substr(1)):"",o=b.p.toppager?"_"+b.p.toppager.substr(1):"";g=parseInt(b.p.page,10)-1;g<0&&(g=0);g=g*parseInt(b.p.rowNum,10);h=g+b.p.reccount;if(b.p.scroll){e=a("tbody:first > tr:gt(0)",b.grid.bDiv);g=h-e.length;
b.p.reccount=e.length;if(e=e.outerHeight()||b.grid.prevRowHeight){f=g*e;l=parseInt(b.p.records,10)*e;a(">div:first",b.grid.bDiv).css({height:l}).children("div:first").css({height:f,display:f?"":"none"});if(b.grid.bDiv.scrollTop==0&&b.p.page>1)b.grid.bDiv.scrollTop=b.p.rowNum*(b.p.page-1)*e}b.grid.bDiv.scrollLeft=b.grid.hDiv.scrollLeft}m=b.p.pager||"";if(m=m+(b.p.toppager?m?","+b.p.toppager:b.p.toppager:"")){l=a.jgrid.formatter.integer||{};e=n(b.p.page);f=n(b.p.lastpage);a(".selbox",m)[this.p.useProp?
"prop":"attr"]("disabled",false);if(b.p.pginput===true){a(".ui-pg-input",m).val(b.p.page);i=b.p.toppager?"#sp_1"+k+",#sp_1"+o:"#sp_1"+k;a(i).html(a.fmatter?a.fmatter.util.NumberFormat(b.p.lastpage,l):b.p.lastpage)}if(b.p.viewrecords)if(b.p.reccount===0)a(".ui-paging-info",m).html(b.p.emptyrecords);else{i=g+1;j=b.p.records;if(a.fmatter){i=a.fmatter.util.NumberFormat(i,l);h=a.fmatter.util.NumberFormat(h,l);j=a.fmatter.util.NumberFormat(j,l)}a(".ui-paging-info",m).html(a.jgrid.format(b.p.recordtext,
i,h,j))}if(b.p.pgbuttons===true){e<=0&&(e=f=0);if(e===1||e===0){a("#first"+k+", #prev"+k).addClass("ui-state-disabled").removeClass("ui-state-hover");b.p.toppager&&a("#first_t"+o+", #prev_t"+o).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#first"+k+", #prev"+k).removeClass("ui-state-disabled");b.p.toppager&&a("#first_t"+o+", #prev_t"+o).removeClass("ui-state-disabled")}if(e===f||e===0){a("#next"+k+", #last"+k).addClass("ui-state-disabled").removeClass("ui-state-hover");b.p.toppager&&
a("#next_t"+o+", #last_t"+o).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{a("#next"+k+", #last"+k).removeClass("ui-state-disabled");b.p.toppager&&a("#next_t"+o+", #last_t"+o).removeClass("ui-state-disabled")}}}d===true&&b.p.rownumbers===true&&a(">td.jqgrid-rownum",b.rows).each(function(b){a(this).html(g+1+b)});c&&b.p.jqgdnd&&a(b).jqGrid("gridDnD","updateDnD");a(b).triggerHandler("jqGridGridComplete");a.isFunction(b.p.gridComplete)&&b.p.gridComplete.call(b);a(b).triggerHandler("jqGridAfterGridComplete")};
b.refreshIndex=y;b.setHeadCheckBox=R;b.constructTr=H;b.formatter=function(a,b,d,c,e){return p(a,b,d,c,e)};a.extend(e,{populate:z,emptyRows:v});this.grid=e;b.addXmlData=function(a){x(a,b.grid.bDiv)};b.addJSONData=function(a){D(a,b.grid.bDiv)};this.grid.cols=this.rows[0].cells;a(b).triggerHandler("jqGridInitGrid");a.isFunction(b.p.onInitGrid)&&b.p.onInitGrid.call(b);z();b.p.hiddengrid=!1}}}})};a.jgrid.extend({getGridParam:function(a){var e=this[0];return!e||!e.grid?void 0:!a?e.p:void 0!==e.p[a]?e.p[a]:
null},setGridParam:function(c){return this.each(function(){this.grid&&"object"===typeof c&&a.extend(!0,this.p,c)})},getDataIDs:function(){var c=[],e=0,d,f=0;this.each(function(){if((d=this.rows.length)&&0<d)for(;e<d;)a(this.rows[e]).hasClass("jqgrow")&&(c[f]=this.rows[e].id,f++),e++});return c},setSelection:function(c,e,d){return this.each(function(){var f,b,h,g,i,j;if(void 0!==c&&(e=!1===e?!1:!0,(b=this.rows.namedItem(""+c))&&b.className&&!(-1<b.className.indexOf("ui-state-disabled"))))if(!0===this.p.scrollrows&&
(h=this.rows.namedItem(c).rowIndex,0<=h&&(f=a(this.grid.bDiv)[0].clientHeight,g=a(this.grid.bDiv)[0].scrollTop,i=a(this.rows[h]).position().top,h=this.rows[h].clientHeight,i+h>=f+g?a(this.grid.bDiv)[0].scrollTop=i-(f+g)+h+g:i<f+g&&i<g&&(a(this.grid.bDiv)[0].scrollTop=i))),!0===this.p.frozenColumns&&(j=this.p.id+"_frozen"),this.p.multiselect){if(this.setHeadCheckBox(!1),this.p.selrow=b.id,g=a.inArray(this.p.selrow,this.p.selarrrow),-1===g?("ui-subgrid"!==b.className&&a(b).addClass("ui-state-highlight").attr("aria-selected",
"true"),f=!0,this.p.selarrrow.push(this.p.selrow)):("ui-subgrid"!==b.className&&a(b).removeClass("ui-state-highlight").attr("aria-selected","false"),f=!1,this.p.selarrrow.splice(g,1),i=this.p.selarrrow[0],this.p.selrow=void 0===i?null:i),a("#jqg_"+a.jgrid.jqID(this.p.id)+"_"+a.jgrid.jqID(b.id))[this.p.useProp?"prop":"attr"]("checked",f),j&&(-1===g?a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(j)).addClass("ui-state-highlight"):a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(j)).removeClass("ui-state-highlight"),
...
"#"+a.jgrid.jqID(j)).removeClass("ui-state-highlight"),a("#"+a.jgrid.jqID(c),"#"+a.jgrid.jqID(j)).addClass("ui-state-highlight")),f=!0):f=!1,this.p.selrow=b.id,e))a(this).triggerHandler("jqGridSelectRow",[b.id,f,d]),this.p.onSelectRow&&this.p.onSelectRow.call(this,b.id,f,d)})},resetSelection:function(c){return this.each(function(){var e=this,d,f,b;!0===e.p.frozenColumns&&(b=e.p.id+"_frozen");if(void 0!==c){f=c===e.p.selrow?e.p.selrow:c;a("#"+a.jgrid.jqID(e.p.id)+" tbody:first tr#"+a.jgrid.jqID(f)).removeClass("ui-state-highlight").attr("aria-selected",
"false");b&&a("#"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(b)).removeClass("ui-state-highlight");if(e.p.multiselect){a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(e.p.id))[e.p.useProp?"prop":"attr"]("checked",!1);if(b)a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(b))[e.p.useProp?"prop":"attr"]("checked",!1);e.setHeadCheckBox(!1)}f=null}else e.p.multiselect?(a(e.p.selarrrow).each(function(c,f){d=e.rows.namedItem(f);a(d).removeClass("ui-state-highlight").attr("aria-selected",
"false");a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(f))[e.p.useProp?"prop":"attr"]("checked",!1);b&&(a("#"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(b)).removeClass("ui-state-highlight"),a("#jqg_"+a.jgrid.jqID(e.p.id)+"_"+a.jgrid.jqID(f),"#"+a.jgrid.jqID(b))[e.p.useProp?"prop":"attr"]("checked",!1))}),e.setHeadCheckBox(!1),e.p.selarrrow=[]):e.p.selrow&&(a("#"+a.jgrid.jqID(e.p.id)+" tbody:first tr#"+a.jgrid.jqID(e.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected","false"),b&&a("#"+a.jgrid.jqID(e.p.selrow),
"#"+a.jgrid.jqID(b)).removeClass("ui-state-highlight"),e.p.selrow=null);!0===e.p.cellEdit&&0<=parseInt(e.p.iCol,10)&&0<=parseInt(e.p.iRow,10)&&(a("td:eq("+e.p.iCol+")",e.rows[e.p.iRow]).removeClass("edit-cell ui-state-highlight"),a(e.rows[e.p.iRow]).removeClass("selected-row ui-state-hover"));e.p.savedRow=[]})},getRowData:function(c){var e={},d,f=!1,b,h=0;this.each(function(){var g=this,i,j;if(void 0===c)f=!0,d=[],b=g.rows.length;else{j=g.rows.namedItem(c);if(!j)return e;b=2}for(;h<b;)f&&(j=g.rows[h]),
a(j).hasClass("jqgrow")&&(a('td[role="gridcell"]',j).each(function(b){i=g.p.colModel[b].name;if("cb"!==i&&"subgrid"!==i&&"rn"!==i)if(!0===g.p.treeGrid&&i===g.p.ExpandColumn)e[i]=a.jgrid.htmlDecode(a("span:first",this).html());else try{e[i]=a.unformat.call(g,this,{rowId:j.id,colModel:g.p.colModel[b]},b)}catch(d){e[i]=a.jgrid.htmlDecode(a(this).html())}}),f&&(d.push(e),e={})),h++});return d||e},delRowData:function(c){var e=!1,d,f;this.each(function(){d=this.rows.namedItem(c);if(!d)return!1;a(d).remove();
...
a(this).removeClass(h)})}});return e},setRowData:function(c,e,d){var f,b=!0,h;this.each(function(){if(!this.grid)return!1;var g=this,i,j,k=typeof d,m={};j=g.rows.namedItem(c);if(!j)return!1;if(e)try{if(a(this.p.colModel).each(function(b){f=this.name;var d=a.jgrid.getAccessor(e,f);void 0!==d&&(m[f]=this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?a.unformat.date.call(g,d,this):d,i=g.formatter(c,d,b,e,"edit"),h=this.title?{title:a.jgrid.stripHtml(i)}:{},!0===g.p.treeGrid&&f===
g.p.ExpandColumn?a("td[role='gridcell']:eq("+b+") > span:first",j).html(i).attr(h):a("td[role='gridcell']:eq("+b+")",j).html(i).attr(h))}),"local"===g.p.datatype){var n=a.jgrid.stripPref(g.p.idPrefix,c),o=g.p._index[n],l;if(g.p.treeGrid)for(l in g.p.treeReader)g.p.treeReader.hasOwnProperty(l)&&delete m[g.p.treeReader[l]];void 0!==o&&(g.p.data[o]=a.extend(!0,g.p.data[o],m));m=null}}catch(p){b=!1}b&&("string"===k?a(j).addClass(d):"object"===k&&a(j).css(d),a(g).triggerHandler("jqGridAfterGridComplete"))});
return b},addRowData:function(c,e,d,f){d||(d="last");var b=!1,h,g,i,j,k,m,n,o,l="",p,q,t,r,s,w;e&&(a.isArray(e)?(p=!0,d="last",q=c):(e=[e],p=!1),this.each(function(){var v=e.length;k=this.p.rownumbers===true?1:0;i=this.p.multiselect===true?1:0;j=this.p.subGrid===true?1:0;if(!p)if(c!==void 0)c=""+c;else{c=a.jgrid.randId();if(this.p.keyIndex!==false){q=this.p.colModel[this.p.keyIndex+i+j+k].name;e[0][q]!==void 0&&(c=e[0][q])}}t=this.p.altclass;for(var y=0,H="",x={},D=a.isFunction(this.p.afterInsertRow)?
true:false;y<v;){r=e[y];g=[];if(p){try{c=r[q];c===void 0&&(c=a.jgrid.randId())}catch(A){c=a.jgrid.randId()}H=this.p.altRows===true?(this.rows.length-1)%2===0?t:"":""}w=c;c=this.p.idPrefix+c;if(k){l=this.formatCol(0,1,"",null,c,true);g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+l+">0</td>"}if(i){o='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+c+'" class="cbox"/>';l=this.formatCol(k,1,"",null,c,true);g[g.length]='<td role="gridcell" '+l+">"+o+"</td>"}j&&
(g[g.length]=a(this).jqGrid("addSubGridCell",i+k,1));for(n=i+j+k;n<this.p.colModel.length;n++){s=this.p.colModel[n];h=s.name;x[h]=r[h];o=this.formatter(c,a.jgrid.getAccessor(r,h),n,r);l=this.formatCol(n,1,o,r,c,x);g[g.length]='<td role="gridcell" '+l+">"+o+"</td>"}g.unshift(this.constructTr(c,false,H,x,r,false));g[g.length]="</tr>";if(this.rows.length===0)a("table:first",this.grid.bDiv).append(g.join(""));else switch(d){case "last":a(this.rows[this.rows.length-1]).after(g.join(""));m=this.rows.length-
1;break;case "first":a(this.rows[0]).after(g.join(""));m=1;break;case "after":(m=this.rows.namedItem(f))&&(a(this.rows[m.rowIndex+1]).hasClass("ui-subgrid")?a(this.rows[m.rowIndex+1]).after(g):a(m).after(g.join("")));m++;break;case "before":if(m=this.rows.namedItem(f)){a(m).before(g.join(""));m=m.rowIndex}m--}this.p.subGrid===true&&a(this).jqGrid("addSubGrid",i+k,m);this.p.records++;this.p.reccount++;a(this).triggerHandler("jqGridAfterInsertRow",[c,r,r]);D&&this.p.afterInsertRow.call(this,c,r,r);
y++;if(this.p.datatype==="local"){x[this.p.localReader.id]=w;this.p._index[w]=this.p.data.length;this.p.data.push(x);x={}}}this.p.altRows===true&&!p&&(d==="last"?(this.rows.length-1)%2===1&&a(this.rows[this.rows.length-1]).addClass(t):a(this.rows).each(function(b){b%2===1?a(this).addClass(t):a(this).removeClass(t)}));this.updatepager(true,true);b=true}));return b},footerData:function(c,e,d){function f(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0}var b,h=!1,g={},i;void 0===c&&(c="get");
"boolean"!==typeof d&&(d=!0);c=c.toLowerCase();this.each(function(){var j=this,k;if(!j.grid||!j.p.footerrow||"set"===c&&f(e))return!1;h=!0;a(this.p.colModel).each(function(f){b=this.name;"set"===c?void 0!==e[b]&&(k=d?j.formatter("",e[b],f,e,"edit"):e[b],i=this.title?{title:a.jgrid.stripHtml(k)}:{},a("tr.footrow td:eq("+f+")",j.grid.sDiv).html(k).attr(i),h=!0):"get"===c&&(g[b]=a("tr.footrow td:eq("+f+")",j.grid.sDiv).html())})});return"get"===c?g:h},showHideCol:function(c,e){return this.each(function(){var d=
this,f=!1,b=a.jgrid.cell_width?0:d.p.cellLayout,h;if(d.grid){"string"===typeof c&&(c=[c]);e="none"!==e?"":"none";var g=""===e?!0:!1,i=d.p.groupHeader&&("object"===typeof d.p.groupHeader||a.isFunction(d.p.groupHeader));i&&a(d).jqGrid("destroyGroupHeader",!1);a(this.p.colModel).each(function(i){if(-1!==a.inArray(this.name,c)&&this.hidden===g){if(!0===d.p.frozenColumns&&!0===this.frozen)return!0;a("tr[role=rowheader]",d.grid.hDiv).each(function(){a(this.cells[i]).css("display",e)});a(d.rows).each(function(){a(this).hasClass("jqgroup")||
a(this.cells[i]).css("display",e)});d.p.footerrow&&a("tr.footrow td:eq("+i+")",d.grid.sDiv).css("display",e);h=parseInt(this.width,10);d.p.tblwidth="none"===e?d.p.tblwidth-(h+b):d.p.tblwidth+(h+b);this.hidden=!g;f=!0;a(d).triggerHandler("jqGridShowHideCol",[g,this.name,i])}});!0===f&&(!0===d.p.shrinkToFit&&!isNaN(d.p.height)&&(d.p.tblwidth+=parseInt(d.p.scrollOffset,10)),a(d).jqGrid("setGridWidth",!0===d.p.shrinkToFit?d.p.tblwidth:d.p.width));i&&a(d).jqGrid("setGroupHeaders",d.p.groupHeader)}})},
hideCol:function(c){return this.each(function(){a(this).jqGrid("showHideCol",c,"none")})},showCol:function(c){return this.each(function(){a(this).jqGrid("showHideCol",c,"")})},remapColumns:function(c,e,d){function f(b){var d;d=b.length?a.makeArray(b):a.extend({},b);a.each(c,function(a){b[a]=d[this]})}function b(b,d){a(">tr"+(d||""),b).each(function(){var b=this,d=a.makeArray(b.cells);a.each(c,function(){var a=d[this];a&&b.appendChild(a)})})}var h=this.get(0);f(h.p.colModel);f(h.p.colNames);f(h.grid.headers);
b(a("thead:first",h.grid.hDiv),d&&":not(.ui-jqgrid-labels)");e&&b(a("#"+a.jgrid.jqID(h.p.id)+" tbody:first"),".jqgfirstrow, tr.jqgrow, tr.jqfoot");h.p.footerrow&&b(a("tbody:first",h.grid.sDiv));h.p.remapColumns&&(h.p.remapColumns.length?f(h.p.remapColumns):h.p.remapColumns=a.makeArray(c));h.p.lastsort=a.inArray(h.p.lastsort,c);h.p.treeGrid&&(h.p.expColInd=a.inArray(h.p.expColInd,c));a(h).triggerHandler("jqGridRemapColumns",[c,e,d])},setGridWidth:function(c,e){return this.each(function(){if(this.grid){var d=
this,f,b=0,h=a.jgrid.cell_width?0:d.p.cellLayout,g,i=0,j=!1,k=d.p.scrollOffset,m,n=0,o;"boolean"!==typeof e&&(e=d.p.shrinkToFit);if(!isNaN(c)){c=parseInt(c,10);d.grid.width=d.p.width=c;a("#gbox_"+a.jgrid.jqID(d.p.id)).css("width",c+"px");a("#gview_"+a.jgrid.jqID(d.p.id)).css("width",c+"px");a(d.grid.bDiv).css("width",c+"px");a(d.grid.hDiv).css("width",c+"px");d.p.pager&&a(d.p.pager).css("width",c+"px");d.p.toppager&&a(d.p.toppager).css("width",c+"px");!0===d.p.toolbar[0]&&(a(d.grid.uDiv).css("width",
c+"px"),"both"===d.p.toolbar[1]&&a(d.grid.ubDiv).css("width",c+"px"));d.p.footerrow&&a(d.grid.sDiv).css("width",c+"px");!1===e&&!0===d.p.forceFit&&(d.p.forceFit=!1);if(!0===e){a.each(d.p.colModel,function(){if(this.hidden===false){f=this.widthOrg;b=b+(f+h);this.fixed?n=n+(f+h):i++}});if(0===i)return;d.p.tblwidth=b;m=c-h*i-n;if(!isNaN(d.p.height)&&(a(d.grid.bDiv)[0].clientHeight<a(d.grid.bDiv)[0].scrollHeight||1===d.rows.length))j=!0,m-=k;var b=0,l=0<d.grid.cols.length;a.each(d.p.colModel,function(a){if(this.hidden===
false&&!this.fixed){f=this.widthOrg;f=Math.round(m*f/(d.p.tblwidth-h*i-n));if(!(f<0)){this.width=f;b=b+f;d.grid.headers[a].width=f;d.grid.headers[a].el.style.width=f+"px";if(d.p.footerrow)d.grid.footers[a].style.width=f+"px";if(l)d.grid.cols[a].style.width=f+"px";g=a}}});if(!g)return;o=0;j?c-n-(b+h*i)!==k&&(o=c-n-(b+h*i)-k):1!==Math.abs(c-n-(b+h*i))&&(o=c-n-(b+h*i));d.p.colModel[g].width+=o;d.p.tblwidth=b+o+h*i+n;d.p.tblwidth>c?(j=d.p.tblwidth-parseInt(c,10),d.p.tblwidth=c,f=d.p.colModel[g].width-=
j):f=d.p.colModel[g].width;d.grid.headers[g].width=f;d.grid.headers[g].el.style.width=f+"px";l&&(d.grid.cols[g].style.width=f+"px");d.p.footerrow&&(d.grid.footers[g].style.width=f+"px")}d.p.tblwidth&&(a("table:first",d.grid.bDiv).css("width",d.p.tblwidth+"px"),a("table:first",d.grid.hDiv).css("width",d.p.tblwidth+"px"),d.grid.hDiv.scrollLeft=d.grid.bDiv.scrollLeft,d.p.footerrow&&a("table:first",d.grid.sDiv).css("width",d.p.tblwidth+"px"))}}})},setGridHeight:function(c){return this.each(function(){if(this.grid){var e=
a(this.grid.bDiv);e.css({height:c+(isNaN(c)?"":"px")});!0===this.p.frozenColumns&&a("#"+a.jgrid.jqID(this.p.id)+"_frozen").parent().height(e.height()-16);this.p.height=c;this.p.scroll&&this.grid.populateVisible()}})},setCaption:function(c){return this.each(function(){this.p.caption=c;a("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl",this.grid.cDiv).html(c);a(this.grid.cDiv).show()})},setLabel:function(c,e,d,f){return this.each(function(){var b=-1;if(this.grid&&void 0!==c&&(a(this.p.colModel).each(function(a){if(this.name===
c)return b=a,!1}),0<=b)){var h=a("tr.ui-jqgrid-labels th:eq("+b+")",this.grid.hDiv);if(e){var g=a(".s-ico",h);a("[id^=jqgh_]",h).empty().html(e).append(g);this.p.colNames[b]=e}d&&("string"===typeof d?a(h).addClass(d):a(h).css(d));"object"===typeof f&&a(h).attr(f)}})},setCell:function(c,e,d,f,b,h){return this.each(function(){var g=-1,i,j;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return g=a,!1}):g=parseInt(e,10),0<=g&&(i=this.rows.namedItem(c)))){var k=a("td:eq("+
g+")",i);if(""!==d||!0===h)i=this.formatter(c,d,g,i,"edit"),j=this.p.colModel[g].title?{title:a.jgrid.stripHtml(i)}:{},this.p.treeGrid&&0<a(".tree-wrap",a(k)).length?a("span",a(k)).html(i).attr(j):a(k).html(i).attr(j),"local"===this.p.datatype&&(i=this.p.colModel[g],d=i.formatter&&"string"===typeof i.formatter&&"date"===i.formatter?a.unformat.date.call(this,d,i):d,j=this.p._index[a.jgrid.stripPref(this.p.idPrefix,c)],void 0!==j&&(this.p.data[j][i.name]=d));"string"===typeof f?a(k).addClass(f):f&&
a(k).css(f);"object"===typeof b&&a(k).attr(b)}})},getCell:function(c,e){var d=!1;this.each(function(){var f=-1;if(this.grid&&(isNaN(e)?a(this.p.colModel).each(function(a){if(this.name===e)return f=a,!1}):f=parseInt(e,10),0<=f)){var b=this.rows.namedItem(c);if(b)try{d=a.unformat.call(this,a("td:eq("+f+")",b),{rowId:b.id,colModel:this.p.colModel[f]},f)}catch(h){d=a.jgrid.htmlDecode(a("td:eq("+f+")",b).html())}}});return d},getCol:function(c,e,d){var f=[],b,h=0,g,i,j,e="boolean"!==typeof e?!1:e;void 0===
d&&(d=!1);this.each(function(){var k=-1;if(this.grid&&(isNaN(c)?a(this.p.colModel).each(function(a){if(this.name===c)return k=a,!1}):k=parseInt(c,10),0<=k)){var m=this.rows.length,n=0;if(m&&0<m){for(;n<m;){if(a(this.rows[n]).hasClass("jqgrow")){try{b=a.unformat.call(this,a(this.rows[n].cells[k]),{rowId:this.rows[n].id,colModel:this.p.colModel[k]},k)}catch(o){b=a.jgrid.htmlDecode(this.rows[n].cells[k].innerHTML)}d?(j=parseFloat(b),h+=j,void 0===i&&(i=g=j),g=Math.min(g,j),i=Math.max(i,j)):e?f.push({id:this.rows[n].id,
value:b}):f.push(b)}n++}if(d)switch(d.toLowerCase()){case "sum":f=h;break;case "avg":f=h/m;break;case "count":f=m;break;case "min":f=g;break;case "max":f=i}}}});return f},clearGridData:function(c){return this.each(function(){if(this.grid){"boolean"!==typeof c&&(c=!1);if(this.p.deepempty)a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:gt(0)").remove();else{var e=a("#"+a.jgrid.jqID(this.p.id)+" tbody:first tr:first")[0];a("#"+a.jgrid.jqID(this.p.id)+" tbody:first").empty().append(e)}this.p.footerrow&&
c&&a(".ui-jqgrid-ftable td",this.grid.sDiv).html("&#160;");this.p.selrow=null;this.p.selarrrow=[];this.p.savedRow=[];this.p.records=0;this.p.page=1;this.p.lastpage=0;this.p.reccount=0;this.p.data=[];this.p._index={};this.updatepager(!0,!1)}})},getInd:function(a,e){var d=!1,f;this.each(function(){(f=this.rows.namedItem(a))&&(d=!0===e?f:f.rowIndex)});return d},bindKeys:function(c){var e=a.extend({onEnter:null,onSpace:null,onLeftKey:null,onRightKey:null,scrollingRows:!0},c||{});return this.each(function(){var d=
this;a("body").is("[role]")||a("body").attr("role","application");d.p.scrollrows=e.scrollingRows;a(d).keydown(function(c){var b=a(d).find("tr[tabindex=0]")[0],h,g,i,j=d.p.treeReader.expanded_field;if(b)if(i=d.p._index[a.jgrid.stripPref(d.p.idPrefix,b.id)],37===c.keyCode||38===c.keyCode||39===c.keyCode||40===c.keyCode){if(38===c.keyCode){g=b.previousSibling;h="";if(g)if(a(g).is(":hidden"))for(;g;){if(g=g.previousSibling,!a(g).is(":hidden")&&a(g).hasClass("jqgrow")){h=g.id;break}}else h=g.id;a(d).jqGrid("setSelection",
h,!0,c);c.preventDefault()}if(40===c.keyCode){g=b.nextSibling;h="";if(g)if(a(g).is(":hidden"))for(;g;){if(g=g.nextSibling,!a(g).is(":hidden")&&a(g).hasClass("jqgrow")){h=g.id;break}}else h=g.id;a(d).jqGrid("setSelection",h,!0,c);c.preventDefault()}37===c.keyCode&&(d.p.treeGrid&&d.p.data[i][j]&&a(b).find("div.treeclick").trigger("click"),a(d).triggerHandler("jqGridKeyLeft",[d.p.selrow]),a.isFunction(e.onLeftKey)&&e.onLeftKey.call(d,d.p.selrow));39===c.keyCode&&(d.p.treeGrid&&!d.p.data[i][j]&&a(b).find("div.treeclick").trigger("click"),
a(d).triggerHandler("jqGridKeyRight",[d.p.selrow]),a.isFunction(e.onRightKey)&&e.onRightKey.call(d,d.p.selrow))}else 13===c.keyCode?(a(d).triggerHandler("jqGridKeyEnter",[d.p.selrow]),a.isFunction(e.onEnter)&&e.onEnter.call(d,d.p.selrow)):32===c.keyCode&&(a(d).triggerHandler("jqGridKeySpace",[d.p.selrow]),a.isFunction(e.onSpace)&&e.onSpace.call(d,d.p.selrow))})})},unbindKeys:function(){return this.each(function(){a(this).unbind("keydown")})},getLocalRow:function(c){var e=!1,d;this.each(function(){void 0!==
c&&(d=this.p._index[a.jgrid.stripPref(this.p.idPrefix,c)],0<=d&&(e=this.p.data[d]))});return e}})})(jQuery);
...
operands:{eq:"==",ne:"!",lt:"<",le:"<=",gt:">",ge:">=",bw:"^",bn:"!^","in":"=",ni:"!=",ew:"|",en:"!@",cn:"~",nc:"!~",nu:"#",nn:"!#"}},a.jgrid.search,c||{});return this.each(function(){var e=this;if(!this.ftoolbar){var d=function(){var b={},d=0,f,h,m={},n;a.each(e.p.colModel,function(){var l=a("#gs_"+a.jgrid.jqID(this.name),!0===this.frozen&&!0===e.p.frozenColumns?e.grid.fhDiv:e.grid.hDiv);h=this.index||this.name;n=c.searchOperators?l.parent().prev().children("a").attr("soper")||c.defaultSearch:this.searchoptions&&
...
s.editoptions.custom_value.call(m,a(".customelement",this),"get"),void 0===o[n])throw"e2";}else throw"e1";}catch(e){"e1"===e&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===e?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_value' "+a.jgrid.edit.msg.novalue,a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,e.message,a.jgrid.edit.bClose)}}t=a.jgrid.checkValues.call(m,o[n],b);if(!1===t[0])return!1;m.p.autoencode&&
(o[n]=a.jgrid.htmlEncode(o[n]));"clientArray"!==j.url&&s.editoptions&&!0===s.editoptions.NullIfEmpty&&""===o[n]&&(p[n]="null")}});if(!1===t[0]){try{var w=m.rows.namedItem(c),v=a.jgrid.findPos(w);a.jgrid.info_dialog(a.jgrid.errors.errcap,t[1],a.jgrid.edit.bClose,{left:v[0],top:v[1]+a(w).outerHeight()})}catch(y){alert(t[1])}return k}i=m.p.prmNames;w=c;v=!1===m.p.keyIndex?i.id:m.p.colModel[m.p.keyIndex+(!0===m.p.rownumbers?1:0)+(!0===m.p.multiselect?1:0)+(!0===m.p.subGrid?1:0)].name;if(o){o[i.oper]=
i.editoper;if(void 0===o[v]||""===o[v])o[v]=c;else if(r.id!==m.p.idPrefix+o[v]&&(i=a.jgrid.stripPref(m.p.idPrefix,c),void 0!==m.p._index[i]&&(m.p._index[o[v]]=m.p._index[i],delete m.p._index[i]),c=m.p.idPrefix+o[v],a(r).attr("id",c),m.p.selrow===w&&(m.p.selrow=c),a.isArray(m.p.selarrrow)&&(i=a.inArray(w,m.p.selarrrow),0<=i&&(m.p.selarrrow[i]=c)),m.p.multiselect))i="jqg_"+m.p.id+"_"+c,a("input.cbox",r).attr("id",i).attr("name",i);void 0===m.p.inlineData&&(m.p.inlineData={});o=a.extend({},o,m.p.inlineData,
j.extraparam)}if("clientArray"===j.url){o=a.extend({},o,l);m.p.autoencode&&a.each(o,function(b,d){o[b]=a.jgrid.htmlDecode(d)});i=a(m).jqGrid("setRowData",c,o);a(r).attr("editable","0");for(v=0;v<m.p.savedRow.length;v++)if(""+m.p.savedRow[v].id===""+w){q=v;break}0<=q&&m.p.savedRow.splice(q,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[c,i,o,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,c,i,j);k=!0;a(r).removeClass("jqgrid-new-row").unbind("keydown")}else a("#lui_"+a.jgrid.jqID(m.p.id)).show(),
p=a.extend({},o,p),p[v]=a.jgrid.stripPref(m.p.idPrefix,p[v]),a.ajax(a.extend({url:j.url,data:a.isFunction(m.p.serializeRowData)?m.p.serializeRowData.call(m,p):p,type:j.mtype,async:!1,complete:function(b,d){a("#lui_"+a.jgrid.jqID(m.p.id)).hide();if("success"===d){var e=!0,f;f=a(m).triggerHandler("jqGridInlineSuccessSaveRow",[b,c,j]);a.isArray(f)||(f=[!0,o]);f[0]&&a.isFunction(j.successfunc)&&(f=j.successfunc.call(m,b));a.isArray(f)?(e=f[0],o=f[1]||o):e=f;if(!0===e){m.p.autoencode&&a.each(o,function(b,
d){o[b]=a.jgrid.htmlDecode(d)});o=a.extend({},o,l);a(m).jqGrid("setRowData",c,o);a(r).attr("editable","0");for(e=0;e<m.p.savedRow.length;e++)if(""+m.p.savedRow[e].id===""+c){q=e;break}0<=q&&m.p.savedRow.splice(q,1);a(m).triggerHandler("jqGridInlineAfterSaveRow",[c,b,o,j]);a.isFunction(j.aftersavefunc)&&j.aftersavefunc.call(m,c,b);k=!0;a(r).removeClass("jqgrid-new-row").unbind("keydown")}else a(m).triggerHandler("jqGridInlineErrorSaveRow",[c,b,d,null,j]),a.isFunction(j.errorfunc)&&j.errorfunc.call(m,
